...
class ModelBuilding:
    def __init__(self, data_path, results_dir):
        """
        Initializes the ModelBuilding object with the dataset and results directory.
        ...
        self.modeling_dir = os.path.join(self.results_dir, "model_building_results")
    ...
    def prepare_and_model(self):
        """
        Prepare the data and apply different models: Linear Regression, Random Forests, and XGBoost.
        """
...
# Example usage of the ModelBuilding class
if __name__ == "__main__":
    ...
    model_building = ModelBuilding(data_path=cleaned_csv_file, results_dir=results_dir)

    # Prepare data and apply modeling techniques
    model_building.prepare_and_model()